# Magento 2 Coupon Codes Import Extension

[Magento 2 Coupon Codes Import](https://www.ulmod.com/coupon-codes-import-for-magento-2.html)  is a Magento 2 extension that allows you to easily import an unlimited number of promo/coupon codes at once via text, CSV files as well as plain-text.

With Magento 2 Coupon Codes Import, you easily transfer promo/coupon codes between Magento 2 sites or installations. Save time on managing coupon codes

<a href="https://www.ulmod.com/coupon-codes-import-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Import any number of coupon codes at once
* Import via plain-text (copy-paste coupon codes list)
* Import via TXT files
* Import via CSV files
* Support CSV and TXT sample import files right in the import settings
* Show a detailed messages during the import

<img src="https://www.ulmod.com/media/ulmod/product_content/promo-import-f.png">
